                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                           <a class="nav-link" href="<?php echo base_url('index.php/video_user') ?>">Video User <span class="sr-only">(current)</span></a>
                        </li>
						<?php } else { ?>
                     <li class="nav-item">
               ...
               <div class="video-block section-padding">
                  <div class="row">
                        ...
                        <div class="main-title">
                           <div class="btn-group float-right right-action">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                 <a class="dropdown-item" href="<?php echo base_url('index.php/video_user') ?>"><i class="fas fa-fw fa-star"></i> &nbsp; Semua</a>
                                 <a class="dropdown-item" href="<?php echo base_url('index.php/video_user/tidak') ?>"><i class="fas fa-fw fa-check-circle"></i> &nbsp; Tidak Revisi</a>
                                 <a class="dropdown-item" href="<?php echo base_url('index.php/video_user/revisi') ?>"><i class="fas fa-fw fa-times-circle"></i> &nbsp; Revisi</a>
                              </div>
                           </div>
                           <h6>Videos</h6>
                        </div>
                     ...
                     if ($this->uri->segment(2) === 'revisi') {
                        $cek = 'revisi';
                        $query_user = $this->db->get_where('video', array('cek' => $cek))->result_array();
                     }
                     elseif ($this->uri->segment(2) === 'tidak') {
                        ...
                        $query_user = $this->db->get_where('video')->result_array();
                     }
                     ...
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                           <div class="video-card-image">
                              ...
                              <div class="time"><?= $row['sasaran'] ?></div>
                           </div>
                           <div class="video-card-body">
                              ...
                              <div class="video-view">
                                 <?php if ($row['prinsip'] == 1) {
                                    echo 'Squash & Stretch';
                                 }
                                 elseif ($row['prinsip'] == 2) {
                                   echo 'Anticipation';
                                 }elseif ($row['prinsip'] == 3) {
                                    echo "Staging";
                                 }elseif ($row['prinsip'] == 4) {
                                    echo "Straight Ahead Action and Pose to Pose";
                                 }elseif ($row['prinsip'] == 5) {
                                    echo "Follow Through and Overlapping Action";
                                 }elseif ($row['prinsip'] == 6) {
                                    echo "Slow In and Slow Out";
                                 }elseif ($row['prinsip'] == 7) {
                                    echo "Arcs";
                                 }elseif ($row['prinsip'] == 8) {
                                    echo "Secondary Action";
                                 }elseif ($row['prinsip'] == 9) {
                                    echo "Timing & Spacing";
                                 }elseif ($row['prinsip'] == 10) {
                                    echo "Exaggeration";
                                 }elseif ($row['prinsip'] == 11) {
                                    echo "Solid Drawing";
                                 }elseif ($row['prinsip'] == 12) {
                                    echo "Appeal";
                                 }
                                 ?>
                              </div>
